...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Use arrow keys to move around. Collect the apples to get bigger. Don't run into yourself or walls.";
	...
	private void gameOver() {
		...
		JOptionPane.showMessageDialog(null, "Your life is over...");
		JOptionPane.showMessageDialog(null, "unless...");
		String again = JOptionPane.showInputDialog("You want to try again? (type yes or no)");
